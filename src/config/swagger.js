const swaggerDefinition = {
    ...
    paths: {
        ...
        , '/v1/appointments': {
            ...
            post: { tags: ['Appointments'], summary: 'Create appointment booking', security: [{ bearerAuth: [] }], requestBody: { required: true, content: { 'application/json': { schema: { type: 'object', required: ['doctorId', 'slotId', 'consultationType'], properties: { doctorId: { type: 'string' }, slotId: { type: 'string' }, consultationType: { type: 'string', enum: ['VIDEO', 'AUDIO', 'CHAT'] }, symptoms: { type: 'string', nullable: true } } } } } }, responses: { 201: { description: 'Appointment created with pending payment' }, 400: { $ref: '#/components/responses/BadRequest' }, 401: { $ref: '#/components/responses/Unauthorized' }, 403: { $ref: '#/components/responses/Forbidden' }, 404: { $ref: '#/components/responses/NotFound' }, 409: { $ref: '#/components/responses/Conflict' } } }
        },
